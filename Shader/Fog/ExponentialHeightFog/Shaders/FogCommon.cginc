...
#define EXP_FOG_COORDS(ID) float4 _fogCoord : TEXCOORD##ID;

// WorldSpaceViewDir : vertex to camera
// GetHeightExponentialFog need camera to vertex
#define TRANSFER_EXP_FOG(v2f, vertex) v2f##._fogCoord = GetExponentialHeightFog(-WorldSpaceViewDir(vertex))

#define APPLY_EXP_FOG(v2f, pixelColor) pixelColor = fixed4(pixelColor.rgb * v2f._fogCoord.a + v2f._fogCoord.rgb, pixelColor.a)

...
namespace PowerVFX
{
    ...
    public class PowerVFXInspector : ShaderGUI
    {
        ...
        static List<string[]> propNameList = new List<string[]> {
            ...
            new []{ "_MainTex", "_MainTexOffsetStop", "_MainTexOffsetUseCustomData_XY", "_Color","_ColorScale", "_MainTexMask","_MainTexMaskUseR" ,"_MainTexUseScreenColor"},
            ...
            new []{ "_DissolveOn","_DissolveRevert", "_DissolveTex", "_DissolveTexUseR", "_DissolveByVertexColor", "_DissolveByCustomData", "_Cutoff", "_DissolveEdgeOn","_DissolveEdgeWidthBy_Custom1", "_EdgeWidth", "_EdgeColor","_EdgeColorIntensity"},

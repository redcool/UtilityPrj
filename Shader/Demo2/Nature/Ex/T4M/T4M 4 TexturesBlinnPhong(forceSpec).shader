...
fixed _ShininessL0, _ShininessL1,_ShininessL2, _ShininessL3;
fixed _GlossIntensity0,_GlossIntensity1,_GlossIntensity2,_GlossIntensity3;
half3 _LightDir;

fixed4 LightingCustomBlinnPhong(SurfaceOutput s, fixed3 lightDir, fixed3 viewDir, fixed atten)
{
  fixed3 h = normalize(_LightDir+viewDir);
...
void surf (Input IN, inout SurfaceOutput o) {
	...
	o.Gloss = splat0.a * splat_control.r * _GlossIntensity0;
	...
	o.Gloss += splat1.a * splat_control.g * _GlossIntensity1;
	...
	o.Gloss += splat2.a * splat_control.b  * _GlossIntensity2;
	...
	o.Gloss += splat3.a * splat_control.a  * _GlossIntensity3;

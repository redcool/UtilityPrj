...
//              for(int i=0; i<int(kSamples); i++) // Loop removed because we kept hitting SM2.0 temp variable limits. Doesn't affect the image too much.
            ...
            OUT.skyColor    = _Exposure * cIn;//(cIn * getRayleighPhase(_WorldSpaceLightPos0.xyz, -eyeRay));
// SKYBOX_SUNDISK_HQ
...
// SKYBOX_SUNDISK_HQ
        ...
        v2f vert(appdata_t v){
            ...
            OUT.eyeRay = normalize(mul((float3x3)unity_ObjectToWorld, v.vertex.xyz));
            Scatter(OUT/**/);

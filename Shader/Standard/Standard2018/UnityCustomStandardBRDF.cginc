...
#define UNITY_HANDLE_CORRECTLY_NEGATIVE_NDOTV 0
    ...
    float3 specularTerm = V*D * UNITY_PI; // Torrance-Sparrow model, Fresnel is applied later

#   ifdef UNITY_COLORSPACE_GAMMA
        specularTerm = sqrt(max(1e-4h, specularTerm));
#   endif
#ifdef _HAIRSPEC_ON
    specularTerm = lerp(specularTerm,strandSpecData.specularTerm,strandSpecData.specMask);
#endif

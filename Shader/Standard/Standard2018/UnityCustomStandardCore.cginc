...
#include "Includes/Tools.cginc"
#if defined(_HAIRSPEC_ON)
    #include "Includes/StrandSpec.cginc"
#endif
//-------------------------------------------------------------------------------------
...
inline FragmentCommonData FragmentSetup (inout float4 i_tex, float3 i_eyeVec, half3 i_viewDirForParallax, float4 tangentToWorld[3], float3 i_posWorld)
{
    ...
    half alpha = Alpha(i_tex.xy);
        ...
        half3 borderColor = (half3)0;
        CheckSphereClip(i_posWorld,borderColor);
    #endif
    ...
    #if defined(_SPHERECLIP_ON)
        o.borderColor = borderColor; // 高亮,用于 bloom
    #endif 
    return o;
}
...
half4 fragForwardBaseInternal (VertexOutputForwardBase i)
{
    ...
    #if defined(_SPHERECLIP_ON)
        c.rgb += s.borderColor * _SphereClipBorderColorScale; // 高亮,用于 bloom
    #endif

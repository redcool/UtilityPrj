...
#pragma target 3.0
//#pragma surface surf SimpleLambert vertex:vert  nodynlightmap nodirlightmap noforwardadd nometa  exclude_path:deferred exclude_path:prepass 
...
struct v2f_surf {
  ...
  float3 custompack0 : TEXCOORD4; // wn
...
fixed4 frag_surf (v2f_surf IN) : SV_Target {
  ...
  #endif
  LightingSimpleLambert_GI(o, giInput, gi);

...
Properties {
	...
	[Toggle(_FEATURE_NONE)]_DisableWeatherOn("Disable Weather ?",int) = 0
...
#pragma multi_compile_fwdbasealpha novertexlight nodynlightmap nodirlightmap noshadow
...
//#pragma surface surf Lambert alpha:fade vertex:vert novertexlights noforwardadd nodynlightmap nodirlightmap noforwardadd nodynlightmap nodirlightmap nometa  exclude_path:deferred exclude_path:prepass 
